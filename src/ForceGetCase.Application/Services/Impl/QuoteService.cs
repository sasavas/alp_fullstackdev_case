...
public class QuoteService : IQuoteService
{
    ...
    private static QuoteDto MapToQuoteDto(QuoteConfig cnf, Quote quote)
    {
        return new QuoteDto(
            ...
            quote.Lenght + " " + cnf.LengthUnits.FirstOrDefault(x => x.Key == quote.Unit1).Value,
            quote.Weight + " " + cnf.WeightUnits.FirstOrDefault(x => x.Key == quote.Unit2).Value,
